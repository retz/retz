...
public class Applications {
    ...
    public static boolean load(com.asakusafw.retz.protocol.Application app) {
    ...
    public static com.asakusafw.retz.protocol.Application encodable(Application app) {
        com.asakusafw.retz.protocol.Application encodable = new com.asakusafw.retz.protocol.Application(
    ...
    public static class Application {
        ...
        public String toVolumeId(String role) {
            return com.asakusafw.retz.protocol.Application.toVolumeId(appName);
        }
    }
}
